...
function TraceError(debuggerName, runCmd, codeDir, processEnv, onDone) {
...
function lldbTrace(runCmd, codeDir, processEnv, onDone) {
...
function gdbTrace(runCmd, codeDir, processEnv, onDone) {
    let files = parseRunCmd(runCmd);
    if (runCmd == null)
        return false;
...
//# sourceMappingURL=errorTracer.js.map